...
::: notes
Use system prompts to control how the model interprets a data visualization. Try tailoring for different audiences.
:::

1. Ask the model to interpret a plot with no special prompting.

2. Edit `prompt.md` to write a system prompt that tailors the interpretation for a specific audience: screen reader alt text, data analyst, non-technical stakeholder, etc.

3. How does the output change? Try different audiences!
