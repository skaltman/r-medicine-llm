...
::: notes
querychat is a package from Posit that lets you explore tabular data in a shiny app using natural language. Instead of writing SQL or dplyr code, you just ask questions in plain English.

do not need to really know shiny! just know shiny makes web apps in r
:::
...
# Your Turn `07_querychat` {.slide-your-turn}
