...
2. Create a basic `mtcars` scatter plot and ask Claude Sonnet 4.6 to interpret it.
...
2. Show this new plot to Claude Sonnet 4.6 and ask it to interpret it. How does it do this time?
